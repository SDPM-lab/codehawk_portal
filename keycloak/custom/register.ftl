<#import "template.ftl" as layout>
    <@layout.registrationLayout
        ...
        <script>
            document.querySelector("#kc-form-buttons").addEventListener("click", async (event) => {
                ...
                const registerData = {
                    ...
                    confirm_password: document.querySelector("#password-confirm").value
                }
                console.log(registerData);
                try {
                    const res = await fetch("https://rap2.sdpmlab.org/backend/app/mock/18/api/v1/user/service", {
                        method: 'POST',
                        body: registerData
                    });
                    console.log(res);
